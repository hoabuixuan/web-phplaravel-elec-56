        ...
        <div class="row main-top-w3l py-2">
            ...
            <div class="col-lg-8 header-right mt-lg-0 mt-2">
                ...
                <ul>
                   ...
                   @if(Auth::check())
                    <li class="text-center border-right text-white">
                        <a href="{{route('logout.social')}}" title="Đăng xuất">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{route('client.updatepw')}}" method="post">
                                        @csrf
                                        <div class="form-group">
                                            <label class="col-form-label">Mật khẩu</label>
                                            <input type="password" class="form-control" placeholder="Nhập mật khẩu mới ..." name="password" required="">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" placeholder="Nhập lại mật khẩu mới ..." name="re_password" required="">
                                        </div>
