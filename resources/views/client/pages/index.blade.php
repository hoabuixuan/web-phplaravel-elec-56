				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							...
							<div class="row">
                                @foreach ($prosamsung as $item)
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img class="img-size" src="img/uploads/products/{{$item->image}}" alt="{{$item->slug}}">
										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<div class="info-product-price my-2">
                                                ...
                                                <del>{{number_format($item->promotional,0,'.',',')}}</del>
                                                @else
                                                <span class="item_price">{{number_format($item->price,0,'.',',')}} VNĐ</span>
                                                @endif
											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<a href="{{route('cart.add',['id' => $item->id])}}">Thêm vào giỏ hàng</a>
											</div>
						...
						<!-- second section -->
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<h3 class="heading-tittle text-center font-italic">{{$pronetwork[0]->categories->name}}</h3>
							<div class="row">
                                @foreach($pronetwork as $pronet)
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img class="img-size" src="img/uploads/products/{{$pronet->image}}" alt="{{$pronet->slug}}">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Xem chi tiết</a>
												</div>
										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<div class="info-product-price my-2">
                                                @if($pronet->promotional>0)
												<span class="item_price">{{number_format($pronet->price,0,'.',',')}}</span>
                                                <del>{{number_format($pronet->promotional,0,'.',',')}}</del>
                                                @else
                                                <span class="item_price">{{number_format($pronet->price,0,'.',',')}}</span>
											...
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="#" method="post">
                                                        <a href="{{route('cart.add',['id' => $pronet->id])}}">Thêm vào giỏ hàng</a>
												</form>
											</div>
										</div>
									</div>
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mt-4">
							...
							<div class="row">
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="asset/client/images/m9.jpg" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
